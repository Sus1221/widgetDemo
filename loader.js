...
function calcDivMeasurements() {
	...
	if(divHeight > 200 && divWidth > 100) {
		...
		divToAdd = "<div style='position:absolute;"+ positionRules + "z-index:200000000;background:white;overflow:hidden;display:inline-block;border:"+ borderStyle + ";" +"' class='outerWidgetDiv'><div style='display: inline-block; position:relative;overflow:hidden; background:white; width:" + divWidth +
