...
function calcDivMeasurements() {
	...
	if(divHeight > 200 && divWidth > 100) {
		...
		divToAdd = "<div style='background:white;display:inline-block;position:fixed;border:"+ borderStyle + ";" + positionRules +"' class='outerWidgetDiv'><div style='display: inline-block; position:relative; background:white; width:" + divWidth +
