...
function calcDivMeasurements() {
	...
	if(divHeight > 200 && divWidth > 100) {
		...
		divToAdd = "<div style='z-index:200000000;background:white;display:inline-block;position:fixed;border:"+ borderStyle + ";" + positionRules +"' class='outerWidgetDiv'><div style='display: inline-block; position:relative;overflow:hidden; background:white; width:" + divWidth +
