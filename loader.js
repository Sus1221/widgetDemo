...
function calcDivMeasurements() {
	...
	if(divHeight > 50 && divWidth > 50) {
		...
		$("<div style='position:relative; border:1px solid black; outline:1px solid darkgray; background:white; width:" + divWidth + "px;height:"+ divHeight + "px;z-index:200000000'><h3 class='XtoRemoveStrossleWidgetDiv' style='position:absolute;top:5px;right:5px;cursor:pointer'>&#10006;</h3></div>").insertBefore(clickedElement);
	}
