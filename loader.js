...
function calcDivMeasurements() {
	...
	if(divHeight > 200 && divWidth > 100) {
		...
		divToAdd = "<div style='z-index:200000000;background:white;display:inline-block;position:fixed;overflow:hidden;border:"+ borderStyle + ";" + positionRules +"' class='outerWidgetDiv'><div style='display: inline-block; position:relative; background:white; width:" + divWidth +
					"px;height:" + divHeight + "px;overflow:hidden' class='widgetDiv'>" +
