...
function calcDivMeasurements() {
	...
	$("<div style='border:1px solid black; outline:1px solid darkgray; background:white; width:" + divWidth + "px;height:"+ divHeight + "px;z-index:200000000'><h3 class='XtoRemoveStrossleWidgetDiv'>X</h3></div>").insertBefore(clickedElement);
